...
class MCP23017(mcp23x17.PinBanks):
    u"""Application programming interface to the MCP23017 GPIO extender"""
    
    def __init__(self, master, address=0x20):
        u"""Initialise to control an MCP23017 at the specified address via the given I2CMaster.
        ...
        """
        super(self.__class__, self).__init__(Registers(master, address))
        

class Registers(mcp23x17.Registers):
    u"""Low level access to the MCP23017 registers
